...
import oop0610.Buyer;
import oop0610.MobilePhone;
import oop0610.Notebook;
import oop0610.Product;
import oop0610.SmartTV;
...
class Buyer{
	...
	//구매한 상품을 저장하는 배열.
	private Product[] item=new Product[10]; //가장 저렴한 금액이 100원, 최대 10개를 살수 있으니까
											//정적인 값으로 지정
	private int idx=0;
...
//	다향성!
	...
	public void disp(){
		...
		for(int n=0;n<item.length;n++){
			if(item[n]==null) break; //10개 선언했는데 구매한 갯수가 5개면 0~4번째까지는 찍어도
									 //5번째부터는 null 빈값. 회전수가 남아있어도 break
			goods=goods+item[n].toString()+" ";
